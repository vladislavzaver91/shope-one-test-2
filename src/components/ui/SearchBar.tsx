		...
		<>
			...
			<div className='relative hidden md:block'>
				<input
					...
					className='max-w-24 sm:max-w-48 pl-8 sm:pl-12 pr-2 sm:pr-4 py-3 rounded-[var(--border-header-input)] border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none'
				/>
