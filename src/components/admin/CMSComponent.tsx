	...
	useEffect(() => {
		const fetchSiteSettings = async () => {
			try {
				...
				if (data) {
					setFont(data.font || 'Nunito')
					setFontColor(data.fontColor || '#171717')
					setAccentColor(data.accentColor || '#2563eb')
					setAccentColorDark(data.accentColorDark || '#1e40af')
					setBorderProductCard(data.borderProductCard || '8px')
					setBorderInfoCard(data.borderInfoCard || '8px')
					setBorderBtn(data.borderBtn || '8px')
					setBorderHeroBtn(data.borderHeroBtn || '50px')
					setBorderHeaderInput(data.borderHeroInput || '50px')
					setBorderInput(data.borderInput || '8px')
				}
			} catch (error) {
