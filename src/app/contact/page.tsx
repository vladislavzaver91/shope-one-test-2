		...
		<div className='heading-section relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 p-7'>
			...
			>
				<motion.h1
					...
					className='font-[family-name:var(--font-nunito-sans)] tracking-wider text-[32px] font-bold text-[#1a237e] mb-8 text-center'
				>
					Contact Us
				</motion.h1>
				...
				>
					...
					<div className='flex items-center space-x-4'>
						<FaPhoneAlt className='h-8 w-8 text-[#1a237e]' />
						<div>
					...
					{/* Email */}
					<div className='flex items-center space-x-4'>
						<FaEnvelope className='h-8 w-8 text-[#1a237e]' />
						<div>
